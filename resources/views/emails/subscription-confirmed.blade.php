...
@section('content')
    <h1>Votre adhésion est confirmée ! ✅</h1>
    
    <p>Bonjour <strong>{{ $user->first_name }} {{ $user->last_name }}</strong>,</p>
    
    <p>Nous avons le plaisir de vous confirmer l'activation de votre adhésion.</p>
    
    <div class="info-box">
        <h2>Détails de votre adhésion</h2>
    ...
    <center>
        <a href="{{ env('FRONTEND_URL') }}/member/subscription" class="button">Voir mon adhésion</a>
    </center>
